...
dbc = Organization.create(
	...
	password: "123456",
	twitter: "@devbootcamp",
	facebook: "http://www.facebook.com/devbootcamp",
...
alice = Artist.create(
	...
	facebook: "http://www.facebook.com/alicepasquini",
...
majd = Artist.create(
	...
	facebook: "http://www.facebook.com/MajdMurad",
	twitter: "@ShaikhMajdi",
...
zoe = Artist.create(
	...
	facebook: "http://www.facebook.com/zoeingram",
	twitter: "@zoeingram",
...
30.times do |i|
	...
	Artist.create(
		...
		facebook: "http://www.facebook.com/" + artist["category"]["text"],
